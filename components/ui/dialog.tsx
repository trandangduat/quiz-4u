...
export const DialogContent = ({ children, className }: DialogContentProps) => {
  ...
  return (
    ...
    >
      <div className={cn(
        "bg-card dark:bg-secondary/30 border-1 backdrop-blur-xl w-full max-w-lg rounded-md p-6 flex flex-col gap-4 transition-all duration-200",
...
export const DialogHeader = ({ className, title, description }: DialogHeaderProps) => {
  ...
  return (
    <div className={cn("flex flex-row justify-between items-center gap-4 p-4 rounded-md bg-secondary/35", className)}>
