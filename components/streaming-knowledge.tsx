...
export default function StreamingKnowledge({
    ...
    return (
        <div className="animate-slide-in">
            <div 
                className={cn(
                    needScroll ? "before:h-12 after:h-12" : "before:h-0 after:h-0",
                    "bg-linear-to-tl border from-secondary to-transparent rounded-md py-4 px-6 max-h-64 overflow-hidden",
