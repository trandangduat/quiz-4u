...
export default async function Page({ params } : { params: Promise<{ quizId: string }> }) {
    ...
    return (
        <>
            <div className="w-full mx-auto px-4 sm:px-6 lg:px-8 flex lg:flex-row flex-col gap-6 items-start">
                <div className="flex flex-col justify-between p-6 bg-card dark:bg-secondary/25 rounded-md w-full basis-[35%] gap-6 self-start">
                    ...
                    <Dialog>
                        <DialogTrigger>
                            <Button className="font-bold p-6 cursor-pointer text-lg w-full">
